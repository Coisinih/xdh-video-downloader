...
import { BotMessageSquare, BrainCircuit, ClipboardCopy, Download, Expand, FileText, GitBranch, ListTree, LoaderCircle, MessageCircleQuestion, RefreshCw, Send, Sparkles, X } from 'lucide-vue-next'
...
async function loadTracks() {
  ...
  tracks.value = []; selectedTrackId.value = ''; cues.value = []; summary.value = null; streamedSummary.value = ''
